...
$pwd = $_REQUEST['senha'];
 ...
 $url = $dns1 . "/player_api.php?username=$user&password=$pwd";
 $resposta = apixtream($url);
 $output = json_decode($resposta,true);
...
$status = $output['user_info']['status'];
 ...
 $url = $dns2 . "/player_api.php?username=$user&password=$pwd";
 $resposta = apixtream($url);
 $output = json_decode($resposta,true);
...
$status = $output['user_info']['status'];
 ...
 $password = $output['user_info']['password'];
  ...
  $url = $dns3 . "/player_api.php?username=$user&password=$pwd";
 $resposta = apixtream($url);
 $output = json_decode($resposta,true);
...
$status = $output['user_info']['status'];
 ...
 $url = $dns4 . "/player_api.php?username=$user&password=$pwd";
 $resposta = apixtream($url);
 $output = json_decode($resposta,true);
...
$status = $output['user_info']['status'];
 ...
 $password = $output['user_info']['password'];
	...
	setcookie("server", "server4", $ts);
	 ...
	 $url = $dns5 . "/player_api.php?username=$user&password=$pwd";
 $resposta = apixtream($url);
 $output = json_decode($resposta,true);
...
$status = $output['user_info']['status'];
 ...
 $password = $output['user_info']['password'];
	...
	if($auth == 0) { echo '<script language="javascript">location = "index.php?sess=erro"</script>';	}
